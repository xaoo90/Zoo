 ...
 * @author Xaoo
 */
public class KeeperFXML implements Initializable {
    ...
    public void showAnimal() throws IOException {
        ap.getChildren().clear();
        ap.getChildren().add(FXMLLoader.load(getClass().getResource("/keeper/animal/AnimalFXML.fxml")));
    }
    
    @FXML
    public void showFeedAnimal() throws IOException {
        ap.getChildren().clear();
        ap.getChildren().add(FXMLLoader.load(getClass().getResource("/keeper/animalFeed/AnimalFeedFXML.fxml")));
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(KeeperFXML.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
