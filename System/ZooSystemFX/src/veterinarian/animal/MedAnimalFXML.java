 ...
 * @author Xaoo
 */
public class MedAnimalFXML implements Initializable {
    ...
    public void addMed(ActionEvent event) throws Exception {
        if (isValidate()) {
            MedExamination med = new MedExamination();
            med.setAnimal(UtilView.getSellectedAnimal());
            ...
            med.setVeterinarian(UtilLogic.getSessionEmployee());
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        boxCondition.setValue(lstBox.get(0));
        lblAnimal.setText(UtilView.getSellectedAnimal().getSpecies() + " " + UtilView.getSellectedAnimal().getSex());
