 ...
 * @author Xaoo
 */
public class HolidayAllFXML implements Initializable {
    ...
    List<HolidayView> lstHoliday = url.holiday(empF.showHoliday(UtilLogic.getSessionEmployee()));
    ...
    @FXML
    public void addHolidayRequest() throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/all/AddHolidayAllFXML.fxml"));
        AnchorPane addEmpl = loader.load();
        Stage addDialogStage = new Stage();
        addDialogStage.setTitle("Dodawanie pośby o urlop");
    ...
    @FXML
    public void delHoliday(ActionEvent event) throws NonexistentEntityException {
        holF.destroy(tablHolidayRequest.getSelectionModel().getSelectedItem().getIdHoliday());
        tablHolidayRequest.getItems().remove(tablHolidayRequest.getSelectionModel().getSelectedItem());
    }

    @Override
    public void initialize(URL url, ResourceBundle rb) {
        tablHolidayCurrent.setPlaceholder(new Label("Brak aktualnych urlopów"));
